...
/*                                                                */
/* Program:     PRCCSR_Mapping_Program_v2025-1.SAS                */
/*                                                                */
/* Procedures:  v2025-1 is compatible with ICD-10-PCS procedure   */
...
/**********************************************/
FILENAME INRAW1  'c:\directory\PRCCSR_v2025-1.csv' LRECL=3000;  * Location of CCSR CSV file.        <===USER MUST MODIFY;
...
* Specify the maximum number of procedure codes on 
  any record in the input file;                              %LET NUMPR=25;         *<===USER MUST MODIFY;
...
/*   SET CCSR VERSION                        */
/*********************************************/ 
%LET PRCCSR_VERSION = "2025.1" ; *<=== DO NOT MODIFY;
